  ...
  var mainNote = svg.append("text")
	...
	//Thank you .text(function(d) {return "Developed by Shipeng Sun (sunsp.gis@gmail.com), Institute on the Environment, University of Minnesota, now at University of Illinois Springfield";});	
    ...
    resetBubbles = function () {
	  ...
	  svg.attr("width", w);
	  //svg.attr("width", w/0.68/0.95);
	  svg.attr("height",h);	      
      d3.select("#bubbleItemNote").text("");
	  //Thank you d3.select("#bubbleItemNote").text("Developed by Shipeng Sun (sunsp.gis@gmail.com), Institute on the Environment, University of Minnesota, now at University of Illinois Springfield");
